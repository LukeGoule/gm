...
template< typename Function > Function CallVFunction(PVOID Base, DWORD Index) // TODO: FIX GOWNOCODE
{
...
#define INPUTSYSTEM_INTERFACE_VERSION	_("InputSystemVersion001")
